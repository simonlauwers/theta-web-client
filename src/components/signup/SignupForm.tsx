        ...
        <form onSubmit={formik.handleSubmit}>
            <Stack style={{maxWidth: "50%"}}>
                ...
                {formik.errors.email && formik.touched.email ? (
                    <div style={{color: "white"}}>{"Uh oh... " + formik.errors.email}</div>) : null}
                ...
                {formik.errors.displayName && formik.touched.displayName ? (
                    <div style={{color: "white"}}>{"Uh oh... " + formik.errors.displayName}</div>) : null}
                ...
                {formik.errors.password && formik.touched.password ? (
                    <div style={{color: "white"}}>{"Uh oh... " + formik.errors.password}</div>) : null}
                ...
                {formik.errors.passwordConfirmation && formik.touched.passwordConfirmation ? (
                    <div style={{color: "white"}}>{"Uh oh... " + formik.errors.passwordConfirmation}</div>) : null}

                <Button style={{marginTop: 25, backgroundColor: "ghostwhite", color: "#141124", fontWeight: "bold"}}
